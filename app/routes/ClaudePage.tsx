...
export function ClaudePage() {
  ...
  const confirmDeleteSession = async () => {
    ...
    await authFetch(`/api/claude/sessions/${deleteTarget.id}`, { method: "DELETE" });
    ...
    <div className="oc-shell claude-shell">
      ...
      <main className="oc-main">
        ...
        {active && (
          <div className="oc-runtime-bar">
            <label>Model</label>
            <select disabled title="Model switching not available for Claude">
              <option value="claude">claude</option>
            </select>
            <label>Approval</label>
            <select title="Claude uses default approval">
      ...
      {deleteTarget && (
        <ConfirmModal
          ...
          message={`Delete "${deleteTarget.title}"? Claude's own history file will not be deleted.`}
          confirmLabel="Delete"
          danger
