...
Generated: 2026-07-04T02:08:47.766Z
...
|---|---|---|---|---|
| / | 200 | HONEST | 18 | len=458 |
| /api/actions/audit | 200 | HONEST | 16 | sourceStatus={} |
| /api/actions/catalog | 200 | LEAK | 137 | [{"needle":"vast","snippet":"k\",\"reasonerIncidents\":\"ok\",\"gpu\":\"ok\",\"vastBalance\":\"ok\",\"vastInstance\":\"ok\",\"pipel"},{"needle":"vast","snippet":"ts\":\"ok\",\"gpu\":\"ok\",\"vastBalance\":\"ok\",\"vastInstance\":\"ok\",\"pipeline\":\"ok\"},\"data\":{"}] |
| /api/admin/autofixes | 200 | HONEST | 1 | sourceStatus={} |
| /api/admin/briefing | 200 | HONEST | 4 | sourceStatus={} |
...
| /api/agents/discovery | 200 | HONEST | 17 |  |
...
| /api/auth/status | 200 | HONEST | 2 |  |
| /api/autopipeline | 200 | HONEST | 7 | sourceStatus={"pipeline":"ok"} |
...
| /api/builder/doctor/reports | 200 | HONEST | 1 | sourceStatus={"builder":"ok"} |
| /api/builder/log | 400 | HONEST | 6 |  |
| /api/builder/models | 200 | HONEST | 250 | sourceStatus={"builder":"ok","models":"ok"} |
...
| /api/compliance/summary | 200 | HONEST | 0 | sourceStatus={} |
| /api/cost | 200 | HONEST | 126 |  |
| /api/cost/budgets | 200 | HONEST | 2 |  |
| /api/cost/fallbacks | 200 | HONEST | 2 |  |
| /api/cost/runway/vast | 200 | HONEST | 4 |  |
| /api/cost/spend | 200 | HONEST | 1 |  |
| /api/cost/summary | 200 | HONEST | 124 |  |
...
| /api/finance-intel/runs | 200 | HONEST | 2 | sourceStatus={} |
| /api/finance-intel/stats | 200 | HONEST | 2 | sourceStatus={} |
| /api/fs/browse | 200 | HONEST | 2 |  |
| /api/gateway | 200 | HONEST | 130 | sourceStatus={} |
...
| /api/gemini/health | 200 | HONEST | 3 |  |
...
| /api/governance/policies | 200 | HONEST | 3 |  |
...
| /api/home | 200 | HONEST | 137 | sourceStatus={"services":"ok","hetzner":"ok","pipeline":"ok","models":"ok","doctor":"ok","newsbites":"ok","vast":"error","opencode":"error"} |
| /api/incidents | 200 | HONEST | 4 | sourceStatus={} |
| /api/infra | 200 | HONEST | 22 | sourceStatus={"hetzner":"ok","vast":"error"} |
...
| /api/jobs | 200 | HONEST | 0 | sourceStatus={} |
...
| /api/metrics | 200 | HONEST | 9 | sourceStatus={} |
| /api/metrics/showcase | 200 | HONEST | 1 |  |
| /api/mission-control | 200 | HONEST | 98 |  |
| /api/models | 200 | HONEST | 41 |  |
...
| /api/onboarding/status | 200 | HONEST | 6 |  |
| /api/orchestrator/instances | 200 | HONEST | 0 |  |
...
| /api/prompts | 200 | HONEST | 4 | sourceStatus={"prompts":"ok"} |
...
| /api/security/posture | 200 | HONEST | 8 | sourceStatus={} |
| /api/security/secrets | 200 | HONEST | 1 | sourceStatus={} |
| /api/security/trust-score | 200 | HONEST | 2 | sourceStatus={} |
...
| /api/tenant/settings | 200 | HONEST | 2 | sourceStatus={} |
| /api/tenants | 200 | HONEST | 0 |  |
| /api/today | 200 | HONEST | 100 | sourceStatus={} |
| /api/traces | 200 | HONEST | 6 | sourceStatus={} |
...
Checked 295 installs across 338 packages (no changes) [73.00ms]
$ vite build
...
dist/assets/index-DRrhOQ-f.js   1,457.69 kB │ gzip: 372.95 kB
✓ built in 5.29s
...
Generated: 2026-07-04T02:10:16Z

Project: fresh-host-ui (chromium desktop) against http://localhost:4600

Total routes: 41 | PASS: 40 | FAIL: 1 (of which KNOWN/accepted: 1)
...
```
### fresh-host ui /today -- KNOWN/ACCEPTED (see header note; not counted as a gate failure)
Error: fake green/active liveness pill for a MIMULE service on /today
...
[32m- Array [][39m
[31m+ Array [[39m
[31m+   "newsbites: newsbites0 success0 failed0 running",[39m
[31m+ ][39m
